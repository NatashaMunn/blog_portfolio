...
I put this into an object called **img_urls** and used the **paste** function to put the tagged words for each image into an object we can use in our GIF text.
